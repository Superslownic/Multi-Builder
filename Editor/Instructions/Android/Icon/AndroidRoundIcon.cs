...
namespace Multi.Builder.Instructions
{
	...
	public class AndroidRoundIcon : IPreBuildInstructionSync
	{
		[ToggleLeft]
		...
		{
			PlatformIcon[] platformIcons = PlayerSettings.GetPlatformIcons(BuildTargetGroup.Android, AndroidPlatformIconKind.Round);
			...
			PlayerSettings.SetPlatformIcons(BuildTargetGroup.Android, AndroidPlatformIconKind.Round, platformIcons);
		}
	}
}